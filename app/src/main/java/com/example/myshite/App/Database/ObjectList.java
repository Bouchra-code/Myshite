...
public class ObjectList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /*Intent intent = getIntent();
        String name1 = intent.getStringExtra("fdata0");
        String name2 = intent.getStringExtra("fdata1");
        MainActivity7.sqLiteHelper.getImage(name1,list);
        MainActivity7.sqLiteHelper.getImage(name2,list);*/
